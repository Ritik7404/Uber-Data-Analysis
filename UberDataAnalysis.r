...
setwd('E:/STUDIER/STUDY MATERIAL/2020/R(programming)/R Project/Uber-dataset')
# creating vector of color to be implemented in our plots
...
# Summarizing and Plotting no. of passengers through out the day by hours
...
# Plotting between month anad hour
...
# Plotting betwwen Month and Day
...
# Heatmap between dayofweek and month

ggplot(month_weekday, aes(dayofweek, month, fill = Total)) +
  geom_tile(color = "white") +
  ggtitle("Heat Map by Month and Day of Week")

# heatmap between base and month
...
# Heatmap between daysofweek and base
...
# Visualizing Rides by base in same period by creating geo-plot
